...
const Terms = () => {
    return (
        <DynamicLegalPage pageType="terms" title="Terms & Conditions" icon={null}>
            <div className="legal-page">
                <div className="legal-plain">
                    ...
                    <p>
                        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://printdoot.com/">https://printdoot.com/</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
                    </p>
